...
function Conclusion() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "relative min-h-screen overflow-y-auto flex items-center justify-center p-8 py-20 bg-paper", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tape", style: {
      ...
      background: "color-mix(in oklab, var(--pop-blue) 70%, white)"
    } }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tape", style: {
      top: 50,
      left: "15%",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-4xl w-full bg-paper ink-border p-12 z-10 animate-pop-in", style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-pop-blue mb-4", style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/codex", className: "absolute -left-8 top-1/2 -translate-y-1/2 ink-border bg-pop-yellow flex items-center justify-center font-display text-4xl text-ink hover:bg-pop-blue hover:text-paper transition-colors z-20 group", style: {
        width: 64,
        height: 80,
        boxShadow: "-6px 6px 0 var(--ink)"
      }, "aria-label": "Back to Commonplace Book", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "transform group-hover:-translate-x-1 transition-transform", children: "‹" }) })
    ] })
  ] });
}
export {
  Conclusion as component
};
